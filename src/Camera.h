...
class Camera : public Object3D {
    ...
    public:
        ...
        void translateCamera(float dx, float dy, const glm::vec3& worldPoint);
...
// Set the clipping planes
inline void Camera::setClippingPlanes(float wnear, float wfar) {
    mNearPlane = wnear;
    mFarPlane = wfar;
    updateProjectionMatrix();
}
...
inline void Camera::setZoom(float fraction) {
    glm::vec3 zoomVector(0, 0, mSceneRadius * fraction * 3.0f);

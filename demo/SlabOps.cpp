...
void InitSlabOps()
{
    Programs.Advect = CreateProgram("Fluid.Vertex.GL3", "Fluid.Advect.GL3");
    Programs.Jacobi = CreateProgram("Fluid.Vertex.GL3", "Fluid.Jacobi.GL3");
    Programs.SubtractGradient = CreateProgram("Fluid.Vertex.GL3", "Fluid.SubtractGradient.GL3");
    Programs.ComputeDivergence = CreateProgram("Fluid.Vertex.GL3", "Fluid.ComputeDivergence.GL3");
    Programs.ApplyImpulse = CreateProgram("Fluid.Vertex.GL3", "Fluid.Splat.GL3");
    Programs.ApplyBuoyancy = CreateProgram("Fluid.Vertex.GL3", "Fluid.Buoyancy.GL3");
}
